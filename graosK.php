    ...
    <div id="fundoTodos">
      ...
      <section id="homeProdutos">
        ...
        <ul class="navbar-nav ml-auto navbar-light">
            <li class="nav-item">              
                <a href="graosG.php" class="btn btn-info customButom ">Gramas</a>
            </li>
            <li class="nav-item divisor">
                
            </li>
            <li class="nav-item">              
                <a href="graosK.php" class="btn btn-info customButom customButomAtivo">Quilograma</a>
            </li>
        </ul>
    </nav>
            ...
            <?php 	
                  ...
                  include_once 'Banco.php';
                      ...
                      $result = mysqli_query($con,"SELECT * FROM tb_graosK ORDER BY nome_graos");

                      
                        while($dados = mysqli_fetch_array($result)){
                        $NomeGraos = $dados['nome_graos'];
                        $valorGraos  = $dados['valor_graos'];
                        $imgGraos = $dados['img_graos'];
                ...
                ?>
                  ...
                  <div class="produtos">
                    <div class="row">
                      <div class="col">
                        <img src="imgProdutos/<?php echo $imgGraos?>" class="imgCustomProdutos">
                      </div>
                      
                      <div class="col">
                        
                          <form action="produtos.php" method="post">
                            <input class="form-control customInput d-none" type="text" value="<?php echo $imgGraos?>" name="img" ReadOnly>
                            <input class="form-control customInput" type="text" value="<?php echo $NomeGraos?>" name="nomeProduto" ReadOnly>
                            <input class="form-control customInput" type="text" value="R$ <?php echo $valorGraos?>" name="valor" ReadOnly>
                            ...
                            <input class="form-control customInput d-none" type="text" value="graosG" name="pagina" ReadOnly>
