    ...
    <div id="fundoTodos">
      ...
      <section id="homeProdutos">
        ...
        <ul class="navbar-nav ml-auto navbar-light">
            <li class="nav-item">              
                <a href="frutasG.php" class="btn btn-info customButom ">Gramas</a>
            </li>
            <li class="nav-item divisor">
                
            </li>
            <li class="nav-item">              
                <a href="frutasK.php" class="btn btn-info customButom customButomAtivo">Quilograma</a>
            </li>
        </ul>
    </nav>
            ...
            <?php 	
                  ...
                  include_once '../Banco.php';
                      ...
                      $result = mysqli_query($con,"SELECT * FROM tb_frutask ORDER BY nome_fruta");

                      
                        while($dados = mysqli_fetch_array($result)){
                        $NomeFruta = $dados['nome_fruta'];
                        $valorFruta  = $dados['valor_fruta'];
                        $imgFruta = $dados['img_fruta'];
                ...
                ?>
                  ...
                  <div class="produtos">
                    <div class="row">
                      <div class="col">
                        <img src="../imgProdutos/<?php echo $imgFruta?>" class="imgCustomProdutos">
                      </div>
                      
                      <div class="col">
                          <form action="produtos.php" method="post">
                            <input class="form-control customInput d-none" type="text" value="<?php echo $imgFruta?>" name="img" ReadOnly>
                            <input class="form-control customInput" type="text" value="<?php echo $NomeFruta?>" name="nomeProduto" ReadOnly>
                            <input class="form-control customInput" type="text" value="R$ <?php echo $valorFruta?>" name="valor" ReadOnly>
                            <input class="form-control customInput" type="number" placeholder="Quantidade" name="quantidade" width="200">
                            <span class="customSpan">1 Quilograma</span>
                            <input class="form-control customInput d-none" type="text" value="1 Quilograma" name="tipo" ReadOnly>
                            <input class="form-control customInput d-none" type="text" value="" name="tamanho" ReadOnly>
                            <input class="form-control customInput d-none" type="text" value="frutaK" name="pagina" ReadOnly>
