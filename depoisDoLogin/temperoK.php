    ...
    <div id="fundoTodos">
      ...
      <section id="homeProdutos">
        ...
        <ul class="navbar-nav ml-auto navbar-light">
            <li class="nav-item">              
                <a href="temperoG.php" class="btn btn-info customButom ">Gramas</a>
            </li>
            <li class="nav-item divisor">
                
            </li>
            <li class="nav-item">              
                <a href="temperoK.php" class="btn btn-info customButom customButomAtivo">Quilograma</a>
            </li>
        </ul>
    </nav>
            ...
            <?php 	
                  ...
                  include_once '../Banco.php';
                      ...
                      $result = mysqli_query($con,"SELECT * FROM tb_temperoK ORDER BY nome_tempero");

                      
                        while($dados = mysqli_fetch_array($result)){
                        $NomeTempero = $dados['nome_tempero'];
                        $valorTempero  = $dados['valor_tempero'];
                        $imgTempero = $dados['img_tempero'];
                ...
                ?>
                  ...
                  <div class="produtos">
                    <div class="row">
                      <div class="col">
                        <img src="../imgProdutos/<?php echo $imgTempero?>" class="imgCustomProdutos">
                      </div>
                      
                      <div class="col">
                        
                          <form action="produtos.php" method="post">
                            <input class="form-control customInput d-none" type="text" value="<?php echo $imgTempero?>" name="img" ReadOnly>
                            <input class="form-control customInput" type="text" value="<?php echo $NomeTempero?>" name="nomeProduto" ReadOnly>
                            <input class="form-control customInput" type="text" value="R$ <?php echo $valorTempero?>" name="valor" ReadOnly>
                            ...
                            <input class="form-control customInput d-none" type="text" value="temperoK" name="pagina" ReadOnly>
