    ...
    <div id="fundoTodos">
      ...
      <section id="homeProdutos">
        ...
        <ul class="navbar-nav ml-auto navbar-light">
            <li class="nav-item">              
                <a href="hortalicasG.php" class="btn btn-info customButom customButomAtivo">Gramas</a>
            </li>
            <li class="nav-item divisor">
                
            </li>
            <li class="nav-item">              
                <a href="hortalicasK.php" class="btn btn-info customButom ">Quilograma</a>
            </li>
        </ul>
    </nav>
            ...
            <?php 	
                  ...
                  include_once '../Banco.php';
                      ...
                      $result = mysqli_query($con,"SELECT * FROM tb_hortalicas ORDER BY nome_hortalicas");
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                          ...
                          <form action="produtos.php" method="post">
                            ...
                            <input class="form-control customInput d-none" type="text" value="hortalicasG" name="pagina" ReadOnly>
