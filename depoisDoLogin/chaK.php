    ...
    <div id="fundoTodos">
      ...
      <section id="homeProdutos">
        ...
        <ul class="navbar-nav ml-auto navbar-light">
            <li class="nav-item">              
                <a href="chaG.php" class="btn btn-info customButom ">Gramas</a>
            </li>
            <li class="nav-item divisor">
                
            </li>
            <li class="nav-item">              
                <a href="chaK.php" class="btn btn-info customButom customButomAtivo">Quilograma</a>
            </li>
        </ul>
    </nav>
            ...
            <?php 	
                  ...
                  include_once '../Banco.php';
                      ...
                      $result = mysqli_query($con,"SELECT * FROM tb_chaK ORDER BY nome_cha");
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                          ...
                          <form action="produtos.php" method="post">
                            ...
                            <input class="form-control customInput d-none" type="text" value="chaK" name="pagina" ReadOnly>
