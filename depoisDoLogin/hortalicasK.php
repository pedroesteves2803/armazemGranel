    ...
    <div id="fundoTodos">
      ...
      <section id="homeProdutos">
        ...
        <ul class="navbar-nav ml-auto navbar-light">
            <li class="nav-item">              
                <a href="hortalicasG.php" class="btn btn-info customButom">Gramas</a>
            </li>
            <li class="nav-item divisor">
                
            </li>
            <li class="nav-item">              
                <a href="hortalicasK.php" class="btn btn-info customButom customButomAtivo">Quilograma</a>
            </li>
        </ul>
    </nav>
            ...
            <?php 	
                  ...
                  include_once '../Banco.php';
                      ...
                      $result = mysqli_query($con,"SELECT * FROM tb_hortalicasK ORDER BY nome_hortalicas");

                      
                        while($dados = mysqli_fetch_array($result)){
                        $NomeHortalicas = $dados['nome_hortalicas'];
                        $valorHortalicas  = $dados['valor_hortalicas'];
                        $imgHortalicas = $dados['img_hortalicas'];
                ...
                ?>
                  ...
                  <div class="produtos">
                    <div class="row">
                      <div class="col">
                        <img src="../imgProdutos/<?php echo $imgHortalicas?>" class="imgCustomProdutos">
                      </div>
                      
                      <div class="col">
                        
                          <form action="produtos.php" method="post">
                            <input class="form-control customInput d-none" type="text" value="<?php echo $imgHortalicas?>" name="img" ReadOnly>
                            <input class="form-control customInput" type="text" value="<?php echo $NomeHortalicas?>" name="nomeProduto" ReadOnly>
                            <input class="form-control customInput" type="text" value="R$ <?php echo $valorHortalicas?>" name="valor" ReadOnly>
                            ...
                            <input class="form-control customInput d-none" type="text" value="hortalicasK" name="pagina" ReadOnly>
